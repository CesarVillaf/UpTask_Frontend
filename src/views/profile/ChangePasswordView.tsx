...
export default function ChangePasswordView() {
  ...
  const { register, handleSubmit, reset, watch, formState: { errors } } = useForm({ defaultValues: initialValues, mode: 'onChange' });
  ...
  useEffect(() => { console.log("Password value:", password); }, [password]);
